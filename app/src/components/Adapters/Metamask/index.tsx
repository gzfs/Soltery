...
function LogosMetamaskIcon(props: QwikIntrinsicElements["svg"], key: string) {
  return (
    <svg
...
export default component$(() => {
  const isMetamask = useSignal(false);

  useVisibleTask$(({ track, cleanup }) => {
    track(() => isMetamask.value);

    cleanup(() => {});
  });
  return (
    <div class="flex w-full items-center justify-between p-3">
      <LogosMetamaskIcon class="h-[30px] w-[30px]" />
